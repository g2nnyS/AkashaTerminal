! function(e, t) {
    ...
    return function(e) {
                            ...
                            return e._listeners.push(t), {
                                dispose: function() {
                                    for (var i = 0; i < e._listeners.length; i++)
                                        if (e._listeners[i] === t) return void e._listeners.splice(i, 1)
                                }
                            }
                        }), this._event
                    },
        ...
        function(e, t, i) {
            ...
            var r = i(3),
                ...
                c = function() {
                    ...
                    return e.prototype.dispose = function() {
                    ...
                    }, e.prototype.onOptionsChanged = function() {}, e.prototype.onBlur = function() {}, e.prototype.onFocus = function() {}, e.prototype.onCursorMove = function() {}, e.prototype.onGridChanged = function(e, t) {}, e.prototype.onSelectionChanged = function(e, t, i) {
                        void 0 === i && (i = !1)
                        ...
                        if (this._ctx.save(), this._ctx.font = this._getFont(!!e.isBold(), !!e.isItalic()), this._ctx.textBaseline = "middle", e.isInverse()) e.isBgDefault() ? this._ctx.fillStyle = this._colors.background.css : e.isBgRGB() ? this._ctx.fillStyle = "rgb(" + o.AttributeData.toColorRGB(e.getBgColor()).join(",") + ")" : this._ctx.fillStyle = this._colors.ansi[e.getBgColor()].css;
                        else if (e.isFgDefault()) this._ctx.fillStyle = this._colors.foreground.css;
                        else if (e.isFgRGB()) this._ctx.fillStyle = "rgb(" + o.AttributeData.toColorRGB(e.getFgColor()).join(",") + ")";
                        else {
                            var r = e.getFgColor();
            ...
            var c = function() {
                ...
                return e.prototype.get = function(e) {
                    ...
                    if (e %= this.length, t < this.length - e) {
                        ...
                        for (n = e; n < this.length; ++n) this.setCell(n, i)
                    ...
                    if (n)
                        for (var o = r - 1; o >= 0; o--)
                            for (var c = 0; c < a; c++) this._data[(i + o) * a + c] = s[(t + o) * a + c];
                    else
                        for (o = 0; o < r; o++)
                            for (c = 0; c < a; c++) this._data[(i + o) * a + c] = s[(t + o) * a + c];
            ...
            var r = i(21),
                ...
                s = function() {
                    ...
                    return e.prototype.addHandler = function(e, t) {
                        ...
                        if (r)
                            for (var s = r.length - 1; s >= 0; s--) r[s].put(e, t, i);
                        ...
                        if (3 !== this._state) {
                            if (1 === this._state)
                                for (; t < i;) {
                                    ...
                                    if (r < 48 || 57 < r) return void(this._state = 3); - 1 === this._id && (this._id = 0), this._id = 10 * this._id + r - 48
                                }
                ...
                a = function() {
                    ...
                    return e.prototype.dispose = function() {
                        ...
                        if (this.reset(), this._ident = e, this._active = this._handlers[e] || o, this._active.length)
                            for (var i = this._active.length - 1; i >= 0; i--) this._active[i].hook(t);
                        else this._handlerFb(this._ident, "HOOK", t)
                    }, e.prototype.put = function(e, t, i) {
                        if (this._active.length)
                            for (var n = this._active.length - 1; n >= 0; n--) this._active[n].put(e, t, i);
        ...
        function(e, t, i) {
            ...
            var l = function() {
                ...
                return e.prototype.registerCharacterJoiner = function(e) {
                    ...
                    for (var i = [], r = t.translateToString(!0), n = 0, s = 0, a = 0, c = t.getFg(0), l = t.getBg(0), h = 0; h < t.getTrimmedLength(); h++)
                        if (t.loadCell(h, this._workCell), 0 !== this._workCell.getWidth()) {
                            if (this._workCell.fg !== c || this._workCell.bg !== l) {
                                if (h - n > 1)
                                    for (var u = this._getJoinedRanges(r, a, s, t, n), f = 0; f < u.length; f++) i.push(u[f]);
                    ...
                    if (this._bufferService.cols - n > 1)
                        for (u = this._getJoinedRanges(r, a, s, t, n), f = 0; f < u.length; f++) i.push(u[f]);
                    return i
                }, e.prototype._getJoinedRanges = function(t, i, r, n, s) {
                    for (var o = t.substring(i, r), a = this._characterJoiners[0].handler(o), c = 1; c < this._characterJoiners.length; c++)
                        for (var l = this._characterJoiners[c].handler(o), h = 0; h < l.length; h++) e._mergeRanges(a, l[h]);
        ...
        function(e, t, i) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.getCoordsRelativeToElement = r, t.getCoords = function(e, t, i, n, s, o, a, c) {
                if (s) {
                    var l = r(e, t);
            ...
            var s = i(34),
                ...
                W = function(e) {
                    ...
                    return n(t, e), Object.defineProperty(t.prototype, "options", {
                        ...
                        this._isDisposed || (e.prototype.dispose.call(this), this._windowsMode && (this._windowsMode.dispose(), this._windowsMode = void 0), this._renderService && this._renderService.dispose(), this._customKeyEventHandler = null, this.write = function() {}, this.element && this.element.parentNode && this.element.parentNode.removeChild(this.element))
        ...
        function(e, t, i) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.prepareTextForTerminal = r, t.bracketTextForPaste = n, t.copyHandler = function(e, t) {
                ...
                C = function(e) {
                    ...
                    return n(t, e), Object.defineProperty(t.prototype, "onCursorMove", {
                        ...
                        var t = this._bufferService.buffer,
                            i = t.x,
                            r = t.y;
                        if (this._logService.debug("parsing data", e), this._parseBuffer.length < e.length && this._parseBuffer.length < 131072 && (this._parseBuffer = new Uint32Array(Math.min(e.length, 131072))), e.length > 131072)
                        ...
                        var r, n, s = this._bufferService.buffer,
                        ...
                        for (var v = t; v < i; ++v) {
                            ...
                            if (c && this._terminal.onA11yCharEmitter.fire(u.stringFromCodePoint(r)), n || !s.x) {
                                if (s.x + n - 1 >= l)
                                    if (h) s.x = 0, s.y++, s.y === s.scrollBottom + 1 ? (s.y--, this._terminal.scroll(!0)) : (s.y >= this._bufferService.rows && (s.y = this._bufferService.rows - 1), s.lines.get(s.y).isWrapped = !0), p = s.lines.get(s.y + s.ybase);
                                    else if (s.x = l - 1, 2 === n) continue;
                                if (f && (p.insertCells(s.x, n, s.getNullCell(_)), 2 === p.getWidth(l - 1) && p.setCellFromCodePoint(l - 1, d.NULL_CELL_CODE, d.NULL_CELL_WIDTH, _.fg, _.bg)), p.setCellFromCodePoint(s.x++, r, n, _.fg, _.bg), n > 0)
                                    for (; --n;) p.setCellFromCodePoint(s.x++, 0, 0, _.fg, _.bg)
                        ...
                        if (!(this._bufferService.buffer.x >= this._bufferService.cols))
                            for (var t = e.params[0] || 1, i = this._bufferService.buffer; t--;) i.x = i.prevStop()
        ...
        function(e, t, i) {
            ...
            var u = function(e) {
                function i(i) {
                    ...
                    return r.TRANSITIONS = i, r.initialState = 0, r.currentState = r.initialState, r._params = new a.Params, r._params.addParam(0), r._collect = 0, r.precedingCodepoint = 0, r._printHandlerFb = function(e, t, i) {}, r._executeHandlerFb = function(e) {}, r._csiHandlerFb = function(e, t) {}, r._escHandlerFb = function(e) {}, r._errorHandlerFb = function(e) {
                        return e
                    }, r._printHandler = r._printHandlerFb, r._executeHandlers = Object.create(null), r._csiHandlers = Object.create(null), r._escHandlers = Object.create(null), r._oscParser = new c.OscParser, r._dcsParser = new l.DcsParser, r._errorHandler = r._errorHandlerFb, r.setEscHandler({
                        final: "\\"
                    }, function() {}), r
                }
                return n(i, e), i.prototype._identifier = function(e, t) {
                    ...
                    for (var i = 0, r = 0, n = this.currentState, s = this._oscParser, o = this._dcsParser, a = this._collect, c = this._params, l = this.TRANSITIONS.table, h = 0; h < t; ++h) {
                        switch ((r = l[n << 8 | ((i = e[h]) < 160 ? i : 160)]) >> 4) {
                            ...
                            case 13:
                                for (var v = h + 1;; ++v)
                                    if (v >= t || 24 === (i = e[v]) || 26 === i || 27 === i || i > 127 && i < 160) {
                                        o.put(e, h, v), h = v - 1;
                                        break
                                    }
                                break;
            ...
            var s = i(41),
                ...
                u = function(e) {
                    ...
                    return n(t, e), t.prototype.resize = function(t) {
                        ...
                        for (var n = e; n <= t; n++)
                            for (var s = n + this._bufferService.buffer.ydisp, o = this._bufferService.buffer.lines.get(s), a = i ? i.getJoinedCharacters(s) : [], h = 0; h < this._bufferService.cols; h++) {
                        ...
                        this._forEachCell(e, t, this._characterJoinerRegistry, function(e, t, r) {
                            if (!e.isInvisible() && (i._drawChars(e, t, r), e.isUnderline())) {
                                if (i._ctx.save(), e.isInverse()) e.isBgDefault() ? i._ctx.fillStyle = i._colors.background.css : e.isBgRGB() ? i._ctx.fillStyle = "rgb(" + a.AttributeData.toColorRGB(e.getBgColor()).join(",") + ")" : i._ctx.fillStyle = i._colors.ansi[e.getBgColor()].css;
                                else if (e.isFgDefault()) i._ctx.fillStyle = i._colors.foreground.css;
                                else if (e.isFgRGB()) i._ctx.fillStyle = "rgb(" + a.AttributeData.toColorRGB(e.getFgColor()).join(",") + ")";
                                else {
                                    var n = e.getFgColor();
        ...
        function(e, t, i) {
            ...
            var p = function(e) {
                function t(t, i) {
                    var r = e.call(this) || this;
                    r._config = i, r._drawToCacheCount = 0, r._glyphsWaitingOnBitmap = [], r._bitmapCommitTimeout = null, r._bitmap = null, r._cacheCanvas = t.createElement("canvas"), r._cacheCanvas.width = u, r._cacheCanvas.height = f, r._cacheCtx = h.throwIfFalsy(r._cacheCanvas.getContext("2d", {
                        alpha: !0
                    }));
                    var n = t.createElement("canvas");
                    n.width = r._config.scaledCharWidth, n.height = r._config.scaledCharHeight, r._tmpCtx = h.throwIfFalsy(n.getContext("2d", {
                        alpha: r._config.allowTransparency
                    })), r._width = Math.floor(u / r._config.scaledCharWidth), r._height = Math.floor(f / r._config.scaledCharHeight);
            ...
            var s = i(12),
                ...
                c = function(e) {
                    ...
                    return n(t, e), t.prototype.resize = function(t) {
                        ...
                        if (e.fg === o.INVERTED_DEFAULT_COLOR ? this._ctx.fillStyle = this._colors.background.css : e.fg && a.is256Color(e.fg) ? this._ctx.fillStyle = this._colors.ansi[e.fg].css : this._ctx.fillStyle = this._colors.foreground.css, e.y1 === e.y2) this._fillBottomLineAtCells(e.x1, e.y1, e.x2 - e.x1);
                        else {
                ...
                s = function() {
                    ...
                    return Object.defineProperty(e.prototype, "onLinkHover", {
                        ...
                        if (void 0 !== this._rowsToLinkify.start && void 0 !== this._rowsToLinkify.end) {
                            ...
                            if (!(t >= e.lines.length)) {
                                for (var i = e.ydisp + Math.min(this._rowsToLinkify.end, this._bufferService.rows) + 1, r = Math.ceil(2e3 / this._bufferService.cols), n = this._bufferService.buffer.iterator(!1, t, i, r, r); n.hasNext();)
        ...
        function(e, t, i) {
            ...
            var a = function() {
                ...
                return e.prototype.createRow = function(e, i, o, a, c, l, h) {
                    for (var u = this._document.createDocumentFragment(), f = 0, _ = Math.min(e.length, h) - 1; _ >= 0; _--)
                        if (e.loadCell(_, this._workCell).getCode() !== s.NULL_CELL_CODE || i && _ === a) {
                            f = _ + 1;
                            break
                        }
                    for (_ = 0; _ < f; _++) {
                        ...
                        if (0 !== d) {
                            ...
                            } else v && p.classList.add("xterm-bg-" + r.INVERTED_DEFAULT_COLOR); if (this._workCell.isBgRGB()) {
                ...
                switch (e.keyCode) {
                    ...
                    default:
                        if (!e.ctrlKey || e.shiftKey || e.altKey || e.metaKey)
                            if (i && !s || !e.altKey || e.metaKey) i && !e.altKey && !e.ctrlKey && e.metaKey ? 65 === e.keyCode && (o.type = 1) : e.key && !e.ctrlKey && !e.altKey && !e.metaKey && e.keyCode >= 48 && 1 === e.key.length ? o.key = e.key : e.key && e.ctrlKey && "_" === e.key && (o.key = r.C0.US);
                            else {
                                var c = n[e.keyCode],
            ...
            var h = function() {
                ...
                return e.prototype.getNullCell = function(e) {
                    ...
                    if (r > this.lines.maxLength && (this.lines.maxLength = r), this.lines.length > 0) {
                        if (this._cols < e)
                            for (var s = 0; s < this.lines.length; s++) this.lines.get(s).resize(e, i);
                        var o = 0;
                        if (this._rows < t)
                            for (var a = this._rows; a < t; a++) this.lines.length < t + this.ybase && (this._optionsService.options.windowsMode ? this.lines.push(new n.BufferLine(e, i)) : this.ybase > 0 && this.lines.length <= this.ybase + this.y + o + 1 ? (this.ybase--, o++, this.ydisp > 0 && this.ydisp--) : this.lines.push(new n.BufferLine(e, i)));
                        else
                            for (a = this._rows; a > t; a--) this.lines.length > t + this.ybase && (this.lines.length > this.ybase + this.y + 1 ? this.lines.pop() : (this.ybase++, this.ydisp++)); if (r < this.lines.maxLength) {
                    ...
                    for (void 0 === i && (i = !1); t;) {
                        ...
                        for (var n = i ? r.getTrimmedLength() : r.length, s = 0; s < n; ++s)
                            if (r.get(s)[o.CHAR_DATA_WIDTH_INDEX] && (t -= r.get(s)[o.CHAR_DATA_CHAR_INDEX].length || 1), t < 0) return [e, s];
                        e++
                    }
                    return [e, 0]
            ...
            var r = this && this.__decorate || function(e, t, i, r) {
                ...
                s = this && this.__spreadArrays || function() {
                    ...
                    var r = Array(e),
                        n = 0;
                    for (t = 0; t < i; t++)
                        for (var s = arguments[t], o = 0, a = s.length; o < a; o++, n++) r[n] = s[o];
                    return r
                };
            Object.defineProperty(t, "__esModule", {
                value: !0
